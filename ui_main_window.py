...
class Ui_window(object):
    def setupUi(self, window):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8(":/adobe.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        window.setWindowIcon(icon)
        self.centralwidget = QtGui.QWidget(window)
        self.centralwidget.setObjectName(_fromUtf8("centralwidget"))
        self.verticalLayout_2 = QtGui.QGridLayout(self.centralwidget)
        ...
        self.verticalLayout_2.addWidget(self.scrollArea,0,0)
        ...
        window.addDockWidget(QtCore.Qt.DockWidgetArea(4), self.dockSearch)
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(_fromUtf8(":/info.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
